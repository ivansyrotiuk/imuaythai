    ...
    return function(dispatch) {
        ...
        return axios
            ...
            .catch(err => {
                dispatch(
                    createAction(
                        actionTypes.LOGIN_ACCOUNT_REJECTED,
                        err.response != null ? err.response.data.Message : 'Cannot connect to server'
                    )
                );
            });
    };
...
export function getRegisterAccount(account) {
    return function(dispatch) {
        ...
        return axios
            ...
            .catch(err => {
                dispatch(createAction(actionTypes.LOGIN_ACCOUNT_REJECTED, err.response.data.Message));
            });
    };
}
...
export function getConfirmAccount(confirmEmail) {
    return function(dispatch) {
        ...
        return axios
            ...
            .catch(err => {
                dispatch(createAction(actionTypes.CONFIRM_EMAIL_REJECTED, err.response.data.Message));
            });
    };
}
...
export function getForgotPassword(forgotPassword) {
    return function(dispatch) {
        ...
        return axios
            ...
            .catch(err => {
                dispatch(createAction(actionTypes.FORGOT_PASSWORD_REJECTED, err.response.data.Message));
            });
    };
}
...
export function getResetPassword(resetPassword) {
    return function(dispatch) {
        ...
        return axios
            ...
            .catch(err => {
                dispatch(createAction(actionTypes.REGISTER_ACCOUNT_REJECTED, err.response.data.Message));
            });
    };
}
