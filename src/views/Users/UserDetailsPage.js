        ...
        <Page>
            ...
            <PageContent>
                ...
                <CollapsiblePanel trigger="Licenses" open={true}>
                    <UserLicenses
                        judgeLicenses={user.judgeLicenses}
                        fighterLicenses={user.fighterLicenses}
                        coachLicenses={user.coachLicenses}
                    />
                </CollapsiblePanel>
            </PageContent>
        </Page>
