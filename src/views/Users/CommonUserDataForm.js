...
import RenderDropZone from '../../components/Common/RenderDropZone';
...
const RenderDatePicker = props => {
    return <Datetime {...props.input} selected={props.input.value} dateFormat="DD-MM-YYYY" timeFormat="HH:mm" />;
};
...
class CommonUserDataForm extends Component {
    render() {
        ...
        const photo = this.props.initialValues != undefined ? this.props.initialValues.photo : undefined;

        return (
            <form onSubmit={handleSubmit}>
                <div className="card">
                    <div className="card-header" style={{ backgroundColor: 'white' }}>
                        <i className="fa fa-id-card-o" aria-hidden="true" /> Common
                    </div>
                    <div className="card-block">
                        <div className="row">
                            <div className="col-md-3">
                                <Field name="photo" component={RenderDropZone} imageUrl={photo} />
                            </div>
                ...
                <div className="card">
                    <div className="card-header" style={{ backgroundColor: 'white' }}>
                        <i className="fa fa-facebook-square" aria-hidden="true" /> Social media
                    </div>
                    <div className="card-block">
                        <div className="form-group row">
                            <div className="col-md-12">
                                <div className="input-group">
                                    <span className="input-group-addon">
                                        <i className="fa fa-facebook" style={inputIconStyle} />
                                    </span>
                                    <Field
                                        name="facebook"
                                        component="input"
                        ...
                        <div className="form-group row">
                            <div className="col-md-12">
                                <div className="input-group">
                                    <span className="input-group-addon">
                                        <i className="fa fa-instagram" style={inputIconStyle} />
                                    </span>
                                    <Field
                                        name="instagram"
                                        component="input"
                        ...
                        <div className="form-group row">
                            <div className="col-md-12">
                                <div className="input-group">
                                    <span className="input-group-addon">
                                        <i className="fa fa-twitter" style={inputIconStyle} />
                                    </span>
                                    <Field
                                        name="twitter"
                                        component="input"
                        ...
                        <div className="form-group row">
                            <div className="col-md-12">
                                <div className="input-group">
                                    <span className="input-group-addon">
                                        <i className="fa fa-vk" style={inputIconStyle} />
                                    </span>
                                    <Field
                                        name="vk"
                                        component="input"
