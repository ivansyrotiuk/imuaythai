    ...
    render() {
        ...
        const mappedFights = fights.map((fight, index) => (
            <FightMoveListItem
                ...
                moveFight={moveFight}
                dragFight={dragFight}
                openFight={openFight.bind(this, fight.id)}
            />
        ));
            ...
            <div>
                <div className="row justify-content-end">
                    <div className="col-md-1">
                        <button className="btn btn-success pull-right" onClick={scheduleFightsClick}>
                            {scheduling && <i className="fa fa-spinner fa-spin fa-1x fa-fw" />}
                            Schedule fights
                        </button>
                    </div>
                    <div className="col-md-1 ml-2">
                        <button className="btn btn-primary pull-right" onClick={tossupJudgesClick}>
                ...
                <Nav tabs>
                    <NavItem>
                        ...
                        >
                            <i className="fa fa-hand-rock-o" /> All fights  <span className="badge badge-pill badge-primary">
                                {' '}
                                {mappedFights.length}
                            </span>
                        </NavLink>
                    ...
                    <NavItem>
                        ...
                        >
                            <i className="fa fa-hand-rock-o" /> Ring A<span className="badge badge-pill badge-info">
                                {' '}
                                {fightsRingA.length}
                            </span>
                        </NavLink>
                    ...
                    <NavItem>
                        ...
                        >
                            <i className="fa fa-hand-rock-o" /> Ring B{' '}
                            <span className="badge badge-pill badge-info"> {fightsRingB.length}</span>
                        </NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink
                        ...
                        >
                            <i className="fa fa-hand-rock-o" /> Ring C{' '}
                            <span className="badge badge-pill badge-info"> {fightsRingC.length}</span>
                        </NavLink>
                    </NavItem>
                </Nav>
