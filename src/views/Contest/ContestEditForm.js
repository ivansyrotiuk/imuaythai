...
const RenderCondestDurationInput = props => (
    <input
        {...props.input}
        type="number"
        name="quantity"
        ...
        placeholder="Contest duration in days"
    />
);
const RenderWaiKhruTimeInput = props => (
    <input
        {...props.input}
        type="number"
        name="quantity"
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-4">
                                            <div className="form-group">
                                                ...
                                                <Field
                                                    name="waiKhruTime"
                                                    component={RenderWaiKhruTimeInput}
                                                    className="form-control"
                                                />
                                            </div>
                                        </div>
                        ...
                        <div className="card">
                            ...
                            <div className="card-block">
                                <div className="row mb-4">
                                    ...
                                    <div className="col-md-2">
                                        <button
                                            ...
                                            onClick={() => {
                                                if (
                                                    contestCategoryId != undefined &&
                                                    (contestCategories == undefined ||
                                                        !contestCategories.find(item => item.id == contestCategoryId))
                                                ) {
                                                    var contestCategory = categories.find(contestCategory => {
                                                        return contestCategory.id == contestCategoryId;
                                                    });
                                                    this.refs.contestCategories
                                ...
                                <FieldArray
                                    ...
                                    component={RenderContestCategoriesTable}
                                    withRef
                                ...
                                <div className="row mb-4">
                                    <div className="col-md-12">
                                        <div className="form-group">
                                            ...
                                            <Field
                                                name="duration"
                                                component={RenderCondestDurationInput}
                                                onChange={this.contestDurationChange}
                                            />
                                        </div>
                                    </div>
                                </div>
...
CreateContestPage = connect(state => {
