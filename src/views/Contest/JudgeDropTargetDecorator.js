...
export const AcceptedJudgeTargetDecorator = DropTarget(dragTypes.JUDGE, acceptedJudgeTarget, collect)(
    JudgeDropTargetDecorator
);
export const MainJudgeTargetDecorator = DropTarget(dragTypes.JUDGE, mainJudgeTarget, collect)(JudgeDropTargetDecorator);
export const RegularJudgeTargetDecorator = DropTarget(dragTypes.JUDGE, regularJudgeTarget, collect)(
    JudgeDropTargetDecorator
);
export const RefereeTargetDecorator = DropTarget(dragTypes.JUDGE, refereeTarget, collect)(JudgeDropTargetDecorator);
export const TimeKeepperTargetDecorator = DropTarget(dragTypes.JUDGE, timeKeepperTarget, collect)(
    JudgeDropTargetDecorator
);
